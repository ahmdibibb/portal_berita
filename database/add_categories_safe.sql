-- Script SQL AMAN untuk menambahkan kategori yang belum ada
-- Tidak menghapus data existing, hanya menambahkan yang kurang

-- 1. Insert kategori yang belum ada (dengan ON CONFLICT DO NOTHING)
