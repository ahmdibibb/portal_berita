-- Script SQL untuk MySQL - Menambahkan kategori yang sesuai dengan navbar
-- Jalankan script ini di database MySQL Anda

-- 1. Insert kategori yang belum ada (dengan INSERT IGNORE untuk MySQL)
INSERT IGNORE INTO Category (id, name, slug, description, createdAt, updatedAt) VALUES
